...
var RoutePlayer = function (_maptalks$Eventable) {
    ...
    RoutePlayer.prototype._createLayers = function _createLayers() {
        this.lineLayer = new VectorLayer(INTERNAL_LAYER_PREFIX + '_routeplay_r_' + this.id, [], {
            visible: this.options['showRoutes'],
            enableSimplify: false
        }).addTo(this._map);
        this.trailLineLayer = new VectorLayer(INTERNAL_LAYER_PREFIX + '_routeplay_t_' + this.id, [], {
